  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-16 sm:py-20">
      ...
      <section className="space-y-8">
        <div>
          <h2 className="text-xl font-serif text-foreground mb-2">{copy.terms.sections.acceptance}</h2>
        ...
        <div>
          <h2 className="text-xl font-serif text-foreground mb-2">{copy.terms.sections.use}</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-xl font-serif text-foreground mb-2">{copy.terms.sections.account}</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-xl font-serif text-foreground mb-2">{copy.terms.sections.content}</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-xl font-serif text-foreground mb-2">{copy.terms.sections.contact}</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">
